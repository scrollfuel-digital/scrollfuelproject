...
const FounderCard = () => {
    ...
    const stats = [
        ...
        { label: "Projects Done", value: "80+", icon: Award },
        { label: "Happy Clients", value: "60+", icon: Star },
    ];
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
                        ...
                        <div className="flex flex-col items-center gap-6 shrink-0">
                            ...
                            >
                                ...
                                {/* Status badge */}
                                <motion.div
                                    className="absolute -bottom-1 left-1/2 -translate-x-1/2 flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold"
                                    style={{ background: '#8bc53f', color: '#000' }}
                                    animate={{ scale: [1, 1.05, 1] }}
                            ...
                            <div className="grid grid-cols-3 lg:grid-cols-1 gap-3 w-full">
                                {stats.map(({ label, value, icon: Icon }, i) => (
                                    <motion.div
                                        ...
                                        whileHover={{ x: 6, borderColor: 'rgba(139,197,63,0.6)' }}
                                        className="flex items-center gap-3 p-3 rounded-xl border border-white/5 transition-all duration-300"
                                        style={{ backgroundColor: 'rgba(255,255,255,0.03)' }}
                                    >
                                        <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0"
                                            style={{ backgroundColor: 'rgba(139,197,63,0.15)' }}>
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`relative p-8 rounded-2xl border-2 backdrop-blur-xl bg-black/60 overflow-hidden transition-all duration-500 ${isPrimary ? 'border-primary/30 hover:border-primary' : 'border-secondary/30 hover:border-secondary'}`}>
                                            <motion.div
                                                className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                                                style={{ background: isPrimary ? 'linear-gradient(135deg, rgba(139, 197, 63, 0.1) 0%, transparent 100%)' : 'linear-gradient(135deg, rgba(255, 201, 59, 0.1) 0%, transparent 100%)' }}
                                            />
                                            <motion.div
                                                className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                                                style={{ boxShadow: isPrimary ? '0 0 40px rgba(139, 197, 63, 0.3)' : '0 0 40px rgba(255, 201, 59, 0.3)' }}
                                            />
                                            <div className="relative z-10 flex items-start gap-4">
                                                <motion.div
                                                    whileHover={{ rotate: 360 }}
                                                    ...
                                                    className={`p-3 rounded-xl ${isPrimary ? 'bg-primary/20' : 'bg-secondary/20'}`}
                                                >
                                                    <card.icon size={32} className={isPrimary ? 'text-primary' : 'text-secondary'} />
                                                </motion.div>
                                                <div className="flex-1">
                                                    <h3 className={`text-2xl font-bold mb-2 transition-colors duration-300 ${isPrimary ? 'text-white group-hover:text-primary' : 'text-white group-hover:text-secondary'}`}>
                                                        {card.title}
                                                ...
                                                <motion.div initial={{ opacity: 0, x: -10 }} whileHover={{ opacity: 1, x: 0 }} className={isPrimary ? 'text-primary' : 'text-secondary'}>
                                                    <ArrowRight size={24} />
                                                </motion.div>
                                            </div>
                                        </div>
