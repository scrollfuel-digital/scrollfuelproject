...
//     try {
//         if (!req.user) {
//             return res.redirect("https://scrollfuel.in/login");
//         }
...
//         // 🔐 Generate JWT (use ID like normal login)
//         const token = jwt.sign(
//             { id: user._id },
//             process.env.JWT_SECRET,
//             { expiresIn: "7d" }
...
//         return res.redirect(
//             `https://scrollfuel.in/admin/auth?token=${token}&user=${encodedUser}`
//         );

//     } catch (error) {
//         console.error("Google Auth Error:", error);
//         return res.redirect("https://scrollfuel.in/login?error=auth_failed");
//     }
// };
